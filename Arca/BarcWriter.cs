...
public class BarcWriter
{
	...
	public BarcWriter() : this(true, InitialSize)
	{
	}

	public BarcWriter(bool autoResize) : this(autoResize, InitialSize)
	{
	}

	public BarcWriter(bool autoResize, int initialSize)
	{
